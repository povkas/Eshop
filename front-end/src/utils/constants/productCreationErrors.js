const errorMesages = {
  ...
  priceError: 'Number is not valid!',
  isEmptyTitle: 'Title is required',
  isEmptyDescription: 'Description is required',
  isEmptyPrice: 'Price is required',
  isEmptyQuantity: 'Quantity is required',
