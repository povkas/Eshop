  ...
  return (
    f({ type: ActionTypes.INIT }),
    {
      ...
      replaceReducer: function(e) {
        ...
        (r = e), f({ type: ActionTypes.REPLACE });
      },
      [result]: function() {
        const e = d;
        return {
...
function getUndefinedStateErrorMessage(e, t) {
  ...
  return (
    `Given ${(o && `action "${o + ""}"`) ||
      "an action"}, reducer "${e}" returned undefined. ` +
    "To ignore an action, you must explicitly return the previous state. If you want this reducer to hold no value, you can return null instead of undefined."
  );
}
function assertReducerShape(e) {
  Object.keys(e).forEach(t => {
    const o = e[t];
    if (void 0 === o(void 0, { type: ActionTypes.INIT }))
      throw Error(
    ...
    if (void 0 === o(void 0, { type: ActionTypes.PROBE_UNKNOWN_ACTION() }))
      throw Error(
...
function applyMiddleware(...e) {
  return t => (...o) => {
    ...
    const i = { getState: r.getState, dispatch: (...e) => n(...e) },
      s = e.map(e => e(i));
    return (n = compose(...s)(r.dispatch)), { ...r, dispatch: n };
  };
}
export {
  createStore,
