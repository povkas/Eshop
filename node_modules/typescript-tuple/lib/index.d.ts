 ...
 */
export declare type SplitInfiniteTuple<
  Tuple extends any[]
> = utils.SplitInfiniteTuple<Tuple>;
/**
 ...
 */
export declare type FirstIndexEqual<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type FirstIndexSubset<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type FirstIndexSuperset<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type LastIndexEqual<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type LastIndexSubset<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type LastIndexSuperset<
  Type,
  Tuple extends any[],
  NotFound = never
 ...
 */
export declare type AllIndexesEqual<
  Type,
  Tuple extends any[]
 ...
 */
export declare type AllIndexesSubset<
  Type,
  Tuple extends any[]
 ...
 */
export declare type AllIndexesSuperset<
  Type,
  Tuple extends any[]
 ...
 */
export declare type Append<Tuple extends any[], Addend> = Reverse<
 ...
 */
export declare type Prepend<Tuple extends any[], Addend> = utils.Prepend<
  Tuple,
  Addend
>;
/**
 ...
 */
export declare type Repeat<Type, Count extends number> = utils.Repeat<
  Type,
  Count,
  []
>;
 ...
 */
export declare type ConcatMultiple<
  TupleSet extends any[][]
> = utils.ConcatMultiple<TupleSet>;
/**
 * Slice a tuple
 ...
 */
export declare type SingleTupleSet<Types extends any[]> = utils.SingleTupleSet<
  Types
>;
/**
 ...
 */
export declare type FillTuple<
  Tuple extends any[],
  Replacement
> = utils.FillTuple<Tuple, Replacement>;
/**
 ...
 */
export declare type CompareLength<
  Left extends any[],
  Right extends any[]
> = utils.CompareLength<Left, Right>;
/**
 ...
 */
export declare type SortTwoTuple<
  Left extends any[],
  Right extends any[],
 ...
 */
export declare type ShortestTuple<
  TupleSet extends [any[], ...any[][]]
> = utils.ShortestTuple<TupleSet>;
/**
 * Find shortest tuple in a set of tuples
 * @example LongestTuple<[[0, 1, 2], [true, false], ['a', 'b', 'c', 'd']]> → ['a', 'b', 'c', 'd']
 */
export declare type LongestTuple<
  TupleSet extends [any[], ...any[][]]
