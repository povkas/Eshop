...
> = _SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
  ? Finite extends any[]
    ...
    : never
  : never;
export declare type _SplitInfiniteTuple<
  Tuple extends any[],
  Holder extends any[] = []
> = {
...
export declare type Last<Tuple extends any[], Default = never> = {
  ...
  ? Element[] extends Tuple
    ...
    : "multi"
  : never];
export declare type Tail<Tuple extends any[]> = ((
  ...args: Tuple
  ...
  infinite: SplitInfiniteTuple<Tuple> extends [infer Finite, infer Infinite]
    ? Finite extends any[]
      ? FirstIndexEqual<
          Type,
          Finite,
          Infinite extends Type[]
            ? Type[] extends Infinite
              ? Finite["length"]
              : NotFound
            : NotFound
        >
...
export declare type _LastIndexFirst<Tuple extends any[], NotFound> = IsFinite<
  Tuple,
  ...
  SplitInfiniteTuple<Tuple> extends [any, infer Infinite]
    ...
    : never
>;
export declare type _IndexesNormalize<Indexes extends any[]> = IsFinite<
  Indexes,
  Indexes extends any[] ? Reverse<Indexes> : never,
  SplitInfiniteTuple<Indexes> extends [infer Finite, infer Infinite]
    ...
    : never
>;
export declare type _AllIndexesEqual<
  Type,
  Tuple extends any[],
  Holder extends any[] = [],
  Count extends any[] = []
...
export declare type _AllIndexesSubset<
  Type,
  Tuple extends any[],
  Holder extends any[] = [],
  Count extends any[] = []
...
export declare type _AllIndexesSuperset<
  Type,
  Tuple extends any[],
  Holder extends any[] = [],
  Count extends any[] = []
...
export declare type Prepend<Tuple extends any[], Addend> = ((
  _: Addend,
  ..._1: Tuple
...
> = {
  ...
  ? "start"
  : "before"];
export declare type SingleTupleSet<
  Types extends any[],
  Holder extends [any][] = []
> = {
  empty: Holder;
