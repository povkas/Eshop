(function(global, factory) {
  ...
  **/
  ...
  (_effectRunnerMap[CANCEL$1] = runCancelEffect),
  ...
  */
  ...
  function take(patternOrChannel, multicastPattern) {
    ...
    if (
      multicast(patternOrChannel) &&
      notUndef(multicastPattern) &&
  ...
  var validateFnDescriptor = function validateFnDescriptor(
    effectName,
    fnDescriptor
  ) {
    check(
  ...
  **/
  ...
  var validateTakeEffect = function validateTakeEffect(
    fn,
    patternOrChannel,
    worker
  ) {
  ...
  function takeEvery$1(patternOrChannel, worker) {
    ...
    return fork.apply(
      void 0,
      [takeEvery, patternOrChannel, worker].concat(args)
    );
  }
  function takeLatest$1(patternOrChannel, worker) {
    ...
    return fork.apply(
      void 0,
      [takeLatest, patternOrChannel, worker].concat(args)
    );
  }
  function takeLeading$1(patternOrChannel, worker) {
    ...
    return fork.apply(
      void 0,
      [takeLeading, patternOrChannel, worker].concat(args)
    );
  }
  ...
  function retry$1(maxTries, delayLength, worker) {
    ...
    return call.apply(
      void 0,
      [retry, maxTries, delayLength, worker].concat(args)
    );
  }
  function debounce(delayLength, pattern, worker) {
    ...
    return fork.apply(
      void 0,
      [debounceHelper, delayLength, pattern, worker].concat(args)
    );
  }
