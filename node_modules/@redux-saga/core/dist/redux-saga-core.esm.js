...
import {
  ...
  w as getMetaInfo,
  x as noop,
  y as createAllStyleChildCallbacks,
  z as createEmptyArray,
  A as assignWithSymbols,
  B as makeIterator,
  C as shouldComplete,
  D as flatMap,
  E as getLocation,
  F as createSetContextWarning,
  G as asyncIteratorSymbol,
  H as shouldCancel,
  I as shouldTerminate,
  J as logError,
  K as wrapSagaDispatch,
  L as identity
} from "./chunk-e922c950.js";
...
function proc(
  ...
  if (
    ...
    iterator$1[asyncIteratorSymbol]
  ) {
    throw new Error(
