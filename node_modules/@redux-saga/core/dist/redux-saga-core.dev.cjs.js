...
var CLOSED_CHANNEL_WITH_TAKERS =
...
function runJoinEffect(env, taskOrTasks, cb, _ref9) {
  ...
  if (is.array(taskOrTasks)) {
    ...
    var childCallbacks = __chunk_1.createAllStyleChildCallbacks(
      taskOrTasks,
      cb
    );
...
function runRaceEffect(env, effects, cb, _ref12) {
  ...
  var effectId = current;
  var keys = Object.keys(effects);
  var response = is.array(effects)
    ? __chunk_1.createEmptyArray(keys.length)
    : {};
  var childCbs = {};
  var completed = false;
  keys.forEach(function(key) {
...
(_effectRunnerMap[__chunk_1.TAKE] = runTakeEffect),
(_effectRunnerMap[__chunk_1.PUT] = runPutEffect),
(_effectRunnerMap[__chunk_1.ALL] = runAllEffect),
(_effectRunnerMap[__chunk_1.RACE] = runRaceEffect),
(_effectRunnerMap[__chunk_1.CALL] = runCallEffect),
(_effectRunnerMap[__chunk_1.CPS] = runCPSEffect),
(_effectRunnerMap[__chunk_1.FORK] = runForkEffect),
(_effectRunnerMap[__chunk_1.JOIN] = runJoinEffect),
(_effectRunnerMap[__chunk_1.CANCEL] = runCancelEffect),
(_effectRunnerMap[__chunk_1.SELECT] = runSelectEffect),
(_effectRunnerMap[__chunk_1.ACTION_CHANNEL] = runChannelEffect),
(_effectRunnerMap[__chunk_1.CANCELLED] = runCancelledEffect),
(_effectRunnerMap[__chunk_1.FLUSH] = runFlushEffect),
(_effectRunnerMap[__chunk_1.GET_CONTEXT] = runGetContextEffect),
(_effectRunnerMap[__chunk_1.SET_CONTEXT] = runSetContextEffect),
_effectRunnerMap);
  ...
  function setContext(props) {
    {
      __chunk_1.check(
        props,
        is.object,
        __chunk_1.createSetContextWarning("task", props)
      );
    }
      ...
      if (isErr) {
        ...
        **/
        ...
        result = is.func(iterator.return)
          ? iterator.return(symbols.TASK_CANCEL)
          : {
              done: true,
...
function runSaga(_ref, saga) {
  ...
  if (sagaMonitor) {
    ...
    sagaMonitor.actionDispatched =
      sagaMonitor.actionDispatched || __chunk_1.noop;
  ...
  sagaMiddleware.setContext = function(props) {
    {
      __chunk_1.check(
        props,
        is.object,
        __chunk_1.createSetContextWarning("sagaMiddleware", props)
      );
    }
