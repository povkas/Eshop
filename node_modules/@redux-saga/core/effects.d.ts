...
export type ChannelTakeEffect<T> = SimpleEffect<
  "TAKE",
...
export type HelperWorkerParameters<
  T,
  Fn extends (...args: any[]) => any
> = Last<Parameters<Fn>> extends T ? AllButLast<Parameters<Fn>> : never;
...
export type PutEffect<A extends Action = AnyAction> = SimpleEffect<
  "PUT",
...
export type ChannelPutEffect<T> = SimpleEffect<
  "PUT",
...
export function call<
  ...
  Name extends string
>(ctxAndFnName: [Ctx, Name], ...args: Parameters<Ctx[Name]>): CallEffect;
/**
...
export function apply<
  Ctx extends { [P in Name]: (this: Ctx, ...args: any[]) => any },
  Name extends string
>(ctx: Ctx, fnName: Name, args: Parameters<Ctx[Name]>): CallEffect;
...
export function fork<
  Ctx extends { [P in Name]: (this: Ctx, ...args: any[]) => any },
  Name extends string
>(ctxAndFnName: [Ctx, Name], ...args: Parameters<Ctx[Name]>): ForkEffect;
/**
...
export type ActionChannelEffect = SimpleEffect<
  "ACTION_CHANNEL",
...
export type CancelledEffect = SimpleEffect<
  "CANCELLED",
...
export type SetContextEffect<C extends object> = SimpleEffect<
  "SET_CONTEXT",
...
export type GetContextEffect = SimpleEffect<
  "GET_CONTEXT",
